...
export default function ListaPokemon() {
    ...
    const initialState =  JSON.parse(localStorage.getItem('pokemonListaPosicion')) || { lista: [], previous: '', next: 'https://pokeapi.co/api/v2/pokemon/?offset=0&limit=20', numero: { desde: '', hasta: ''} };
